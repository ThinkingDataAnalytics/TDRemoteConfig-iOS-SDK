...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ThinkingDataAnalytics/TDRemoteConfig-iOS-SDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ThinkingData, Inc' => 'sdk@thinkingdata.cn' }
  s.source           = { :git => 'https://github.com/ThinkingDataAnalytics/TDRemoteConfig-iOS-SDK.git', :tag => "v#{s.version}" }
